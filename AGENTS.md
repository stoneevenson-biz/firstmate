...
- Every refusal prints `REFUSED[<rail>]` naming which door stopped it - `pr-ref/foreign-host`, `passthrough/repo-flag`, `target/not-origin`, and so on. Read the rail; it says what to change.
